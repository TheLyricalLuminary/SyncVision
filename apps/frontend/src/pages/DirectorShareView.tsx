...
export default function DirectorShareView() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#06030F', fontFamily: '"Manrope", system-ui, sans-serif', WebkitFontSmoothing: 'antialiased', color: '#E2E8F0' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px 80px' }}>

        {/* ── Sender header ── */}
        <div style={{ borderBottom: '1px solid rgba(167,139,250,0.20)', paddingBottom: 32, marginBottom: 32 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              {/* Avatar */}
              <div style={{ width: 38, height: 38, borderRadius: 12, background: 'linear-gradient(135deg, #7C3AED, #DB2777)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              ...
              <div>
                <div style={{ color: '#E2E8F0', fontWeight: 600 }}>Shared by Jessica Mendoza</div>
                <div style={{ color: 'rgba(167,139,250,0.7)', fontSize: 13, display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
          ...
          {/* Scene brief card */}
          <div style={{ marginTop: 32, background: 'linear-gradient(135deg, #170B33, #0F0823)', border: '1px solid rgba(167,139,250,0.20)', borderRadius: 24, padding: '28px 32px' }}>
            <div style={{ fontSize: 10, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(167,139,250,0.7)', marginBottom: 10 }}>The Scene</div>
            <p style={{ fontFamily: '"Instrument Serif", Georgia, serif', fontSize: 22, lineHeight: 1.3, color: '#E2E8F0', fontStyle: 'italic', margin: 0 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 28, flexWrap: 'wrap', gap: 8 }}>
          <h2 style={{ fontFamily: '"Instrument Serif", Georgia, serif', fontSize: 28, fontWeight: 400, color: '#E2E8F0', margin: 0 }}>
            Three for your call
          </h2>
          <span style={{ fontSize: 12, color: '#A78BFA', letterSpacing: '0.06em' }}>Ranked by AI fit</span>
        </div>
        ...
        {/* ── Decision summary ── */}
        {decidedCount > 0 && (
          <div style={{ marginTop: 56, border: '1px solid rgba(167,139,250,0.20)', borderRadius: 24, padding: '36px 32px', background: '#170B33', textAlign: 'center' }}>
            <div style={{ fontSize: 10, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#A78BFA', marginBottom: 14 }}>Decision Summary</div>
            <div style={{ fontFamily: '"Instrument Serif", Georgia, serif', fontSize: 40, fontWeight: 400, color: '#E2E8F0', lineHeight: 1.1 }}>
              <span style={{ color: '#34D399' }}>{approvedCount} Approved</span>
              {passedCount > 0 && <> · {passedCount} Passed</>}
            </div>
            <div style={{ marginTop: 10, fontSize: 13, color: 'rgba(167,139,250,0.70)' }}>
              Your choices will sync back to Jessica in real time
            </div>
          </div>
        )}

        <div style={{ marginTop: 48, textAlign: 'center', fontSize: 11, color: 'rgba(167,139,250,0.45)', letterSpacing: '0.04em' }}>
