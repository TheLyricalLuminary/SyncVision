...
if ! npx prisma migrate deploy 2>&1; then
  ...
  npx prisma migrate resolve --applied 20260612_add_is_archived_to_track || true
  npx prisma migrate resolve --applied 20260613_add_missing_rights_profile_columns || true
  npx prisma migrate resolve --applied 20260613_add_missing_track_columns || true
