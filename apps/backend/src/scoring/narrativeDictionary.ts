...
const NARRATIVE_DICTIONARY: Record<string, BriefPool> = {
  ...
  "romance-intimacy": {
    ...
    FAIL: [
      ...
      { text: "Drum kit enters on the first bar with a full backbeat — the rhythmic floor immediately dictates a level of arousal that eliminates this from any close-proximity scene. Structural conflict with the brief regardless of the topline.", lane: 'scene' },
  ...
  "quirky-offbeat": {
    ...
    FAIL: [
      ...
      { text: "Arousal sits too high and dominance reads too assertive for a brief built on light touch — the rock-grade kit with crash cymbals sets an energy floor that eliminates this from any deadpan or offbeat placement. The arrangement's register contradicts the tonal wit the brief requires.", lane: 'scene' },
  ...
  "opening-closing-title": {
    ...
    FAIL: [
      ...
      // FLAGGED: pure deliverable-completeness argument (no stems, no extended mix, no instrumental) — no PAD/scene dimension can be honestly attached; left untagged for editorial decision
      { text: "Mix is mastered for streaming-single delivery with no instrumental, no extended mix, and no stems available — main-title cutdowns require all three. Deliverable set is incomplete for the use.", lane: 'scene' },
