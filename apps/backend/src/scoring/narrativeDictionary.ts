...
const NARRATIVE_DICTIONARY: Record<string, BriefPool> = {
  ...
  "chase-tension": {
    ...
    FAIL: [
      ...
      // AMBIGUOUS: vocal-arrangement argument (recurring hook vs dialogue) maps plausibly to lyrics axis; annotated 'lyrics' as arrangement/content conflict
      ...
      { text: "Button ending is decisive and clean, which is the opposite of what a sustained-threat cue needs — chases should bleed across scene boundaries, not punctuate them. Structural conflict with how the brief edits.", lane: 'lyrics' },
  ...
  "action-combat": {
    ...
    FAIL: [
      ...
      { text: "Arrangement is verse-chorus-verse with no climactic third act — the cue plateaus where the set piece needs to escalate. Structural pop-song shape against a three-act picture demand; would need a wholesale arrangement rewrite to serve.", lane: 'lyrics' },
      // AMBIGUOUS: runtime/deliverable argument (cue length vs scene length); positionally mapped to 'lyrics' — rewrite candidate to strengthen arrangement content
      { text: "Cue runs short with no extended mix available — the set piece as locked exceeds the song's runtime and it does not loop cleanly past the second chorus. Stems cannot rebuild the missing footage without audible seams.", lane: 'lyrics' },
  ...
  "heartbreak-separation": {
    ...
    FAIL: [
      ...
      { text: "Cue is built around a hard stop at the structural close with no fade alt — a montage edit needs the cue to either bleed or breathe out, not punctuate. Structural conflict with how this kind of sequence is cut.", lane: 'lyrics' },
  ...
  "romance-intimacy": {
    ...
    FAIL: [
      ...
      { text: "Drum kit enters on the first bar with a full backbeat — the rhythmic floor immediately dictates a level of arousal that eliminates this from any close-proximity scene. Structural conflict with the brief regardless of the topline.", lane: 'lyrics' },
      // AMBIGUOUS: mastering/mix argument (loudness hierarchy); positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement dimension
      { text: "Arrangement is mixed loud and forward by mastering choice — even at low playback level the cue competes with quiet dialogue rather than yielding to it. Mix hierarchy is wrong for an underscore role.", lane: 'lyrics' },
  ...
  "emotional-resolution": {
    ...
    FAIL: [
      ...
      { text: "Arrangement contains a hard tempo change in the second half — the cue accelerates from a mid-tempo groove to an uptempo drive, which fractures the temporal coherence a montage depends on. Structural conflict with how the brief edits.", lane: 'lyrics' },
  ...
  "drama-confrontation": {
    ...
    FAIL: [
      ...
      { text: "Drum kit enters from the top with a backbeat — there is no version of a restrained dialogue underscore that carries an audible kick and snare. Structural conflict with the brief, regardless of the harmonic content.", lane: 'lyrics' },
      // AMBIGUOUS: loudness/mix argument (technical delivery); positionally mapped to 'lyrics' — rewrite candidate to foreground underscore arrangement conflict
      { text: "Cue is mixed at commercial-release loudness with a brick-wall master — even at low playback level the dynamic range is too compressed to sit under dialogue without continuous ducking. Master is not underscore-grade.", lane: 'lyrics' },
  ...
  "suspense-dread": {
    ...
    FAIL: [
      ...
      { text: "Cue is built on a 2/4 backbeat throughout, and the rhythmic regularity itself eliminates this from any psychological-suspense placement. Dread requires temporal ambiguity; this arrangement provides metronomic certainty.", lane: 'lyrics' },
  ...
  "horror-psychological": {
    ...
    FAIL: [
      ...
      { text: "Cue is in 4/4 with a clearly audible kick on the downbeat — the rhythmic regularity provides the temporal anchor that horror atmosphere is structurally trying to remove. Wrong arrangement shape for the brief.", lane: 'lyrics' },
      // AMBIGUOUS: technical mix/delivery argument (phase artifacts on downmix); positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement usability
      { text: "Mix translates from 5.1 to stereo with significant phase artifacts in the high-frequency design layer — the horror textures collapse on standard delivery formats. Master is not delivery-ready.", lane: 'lyrics' },
  ...
  "quirky-offbeat": {
    ...
    FAIL: [
      ...
      { text: "Drum kit is rock-grade with a fully tracked kit and crash cymbals — the arrangement scale is wrong for a comedy brief built on light orchestration and rhythmic unpredictability. Structural mismatch.", lane: 'lyrics' },
      { text: "Cue is built around a hard button at every eight bars — the editor cannot run it under any dialogue scene without the music continuously interrupting the comedic rhythm of the performances.", lane: 'lyrics' },
  ...
  "comedy-light": {
    ...
    FAIL: [
      ...
      { text: "Cue contains a tempo-halving bridge in the second half that holds for forty bars — comedy montage cannot survive a forty-bar slowdown without losing the audience's energy. Structural conflict with the brief.", lane: 'lyrics' },
  ...
  "opening-closing-title": {
    ...
    FAIL: [
      ...
      { text: "Cue is built around a verse-chorus pop structure that does not compress into a 30-second main-title cutdown without losing its arc. Structural shape is the issue, not the topline.", lane: 'lyrics' },
      // AMBIGUOUS: deliverable/stems argument; positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement format conflict
      { text: "Mix is mastered for streaming-single delivery with no instrumental, no extended mix, and no stems available — main-title cutdowns require all three. Deliverable set is incomplete for the use.", lane: 'lyrics' },
  ...
  "euphoria-celebration": {
    ...
    FAIL: [
      ...
      // AMBIGUOUS: runtime/deliverable argument (cue too short, no extended mix); positionally mapped to 'lyrics' — rewrite candidate to foreground structural shape conflict
      { text: "Cue is under ninety seconds with no extended mix available — credit crawls require a minimum runtime this song does not support. Structural deliverable conflict.", lane: 'lyrics' },
  ...
  "cinematic-epic": {
    ...
    FAIL: [
      ...
      { text: "Cue is structurally a four-on-the-floor pop arrangement with orchestral overdubs — the underlying rhythmic floor is wrong for theatrical scale regardless of the string layer on top. Arrangement architecture mismatch.", lane: 'lyrics' },
      // AMBIGUOUS: loudness/dynamic range argument (mix format); positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement delivery conflict
      { text: "Master mix is loud-pop-grade with brick-wall limiting — the dynamic range is too compressed for theatrical mix-stage delivery. Music will fight rather than collaborate with sound design.", lane: 'lyrics' },
  ...
  "nature-pastoral": {
    ...
    FAIL: [
      ...
      { text: "Cue is built on a programmed kick and synth bass that immediately register as electronic — incompatible with an organic pastoral brief regardless of any acoustic layer above. Production-aesthetic mismatch.", lane: 'lyrics' },
      // AMBIGUOUS: loudness/mix argument; positionally mapped to 'lyrics' — rewrite candidate to foreground organic register conflict
      { text: "Mix is mastered loud with brick-wall limiting — pastoral coverage requires dynamic range to breathe with the picture, and this cue cannot pull back without becoming inaudible. Master is wrong format for the use.", lane: 'lyrics' },
  ...
  "montage-transition": {
    ...
    FAIL: [
      ...
      { text: "Cue contains a hard tempo change in the opening section that fractures the temporal continuity transitions exist to provide. Structural conflict with how the brief functions in the edit.", lane: 'lyrics' },
  ...
  "triumph-victory": {
    ...
    FAIL: [
      ...
      // AMBIGUOUS: runtime/deliverable argument (cue too short, no loop); positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement structural shortfall
      { text: "Cue runs well short with no extended mix — sports-triumph coverage including credits and highlight tags typically needs substantial runtime, and this song does not loop without seams. Deliverable shortfall.", lane: 'lyrics' },
  ...
  "grief-loss": {
    ...
    FAIL: [
      ...
      { text: "Drum kit enters in the opening section with a backbeat — there is no version of a low-arousal grief underscore that carries audible drums. Structural conflict with how the brief breathes.", lane: 'lyrics' },
      // AMBIGUOUS: loudness/technical delivery argument; positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement incompatibility
      { text: "Cue is mixed at commercial-pop loudness with brick-wall limiting — the dynamic range required to sit under quiet grief coverage is not available in the master. Master is wrong format for the use.", lane: 'lyrics' },
  ...
  "contemplative-reflective": {
    ...
    FAIL: [
      ...
      { text: "Cue is built around a 4/4 backbeat and a structured verse-chorus arrangement — contemplative coverage requires temporal openness that this song-shape cannot provide. Structural conflict with the brief.", lane: 'lyrics' },
  ...
  "urban-gritty": {
    ...
    FAIL: [
      ...
      // AMBIGUOUS: loudness/technical delivery argument; positionally mapped to 'lyrics' — rewrite candidate to foreground arrangement format conflict
      { text: "Cue is mixed at commercial-release loudness with brick-wall limiting that does not translate cleanly to social-platform loudness normalization. Deliverable will be artifacted at TikTok and Reels delivery specs.", lane: 'lyrics' },
