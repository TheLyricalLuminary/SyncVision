...
export const NARRATIVE_EVENTS: NarrativeEvent[] = [
  ...
  { id: "realization", triggers: ["realizes", "realization", "it dawns", "understands at last"], intensity: 2, affinity: [0.0, 0.15, 0.7, 0.15], valence: 0.1 },
  ...
  { id: "revelation", triggers: ["reveals", "revelation", "the truth comes out", "discovers"], intensity: 3, affinity: [0.0, 0.05, 0.85, 0.1], valence: 0.0 },
  { id: "betrayal", triggers: ["betrayal", "betrays", "betrayed", "double-cross", "backstab"], intensity: 3, affinity: [0.0, 0.15, 0.75, 0.1], valence: -0.9 },
  { id: "revenge", triggers: ["revenge", "vengeance", "avenge", "avenges", "payback", "retribution", "gets even"], intensity: 3, affinity: [0.0, 0.1, 0.55, 0.35], valence: -0.8 },
  ...
  { id: "farewell", triggers: ["farewell", "goodbye", "leaves for the last time", "parting"], intensity: 2, affinity: [0.05, 0.2, 0.15, 0.6], valence: -0.3 },
